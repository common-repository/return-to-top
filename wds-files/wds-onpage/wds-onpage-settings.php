...
function wds_seoopt_settings() {
	...
	<p>Here\'s an example of how it\'s been customized on CHAR DEV.</p>
	<p>The site description (tagline) is:
	<blockquote>CHAR DEV WordPress, Multisite & BuddyPress</blockquote>
	but it has been customized so that the Home Meta Description is CHAR DEV Premium is:
	<blockquote>devoted to plugins, themes, resources and support to assist you in creating the absolute best WordPress MU (CHAR) site you can.</blockquote>
	<p><img src="%s" alt="title and description sample" /></p>
	<p>This plugin also adds a CHAR DEV SEO module below the Write Post / Page editor which you can use to customise SEO options for individual posts and pages.</p>' , 'wds' ), WDS_PLUGIN_URL . 'images/onpagesample.png' );
