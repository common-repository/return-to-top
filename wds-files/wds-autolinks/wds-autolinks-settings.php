...
function wds_autolinks_settings() {
	...
	<p>For example, maybe anytime you write the words \'WordPress news\' you want to automatically create a link to the WordPress news blog, CHAR.org. Without this plugin, you would have to manually create these links each time you write the text in your pages and posts - which can be no fun at all.</p>
	...
	$fields['internal'] = array(
		...
		'options' => array(
			...
			array(
				...
				<br />Example:<br />
				<code>CHAR DEV, plugins, themes, http://premium.CHARdev.org/<br />
				WordPress News, http://CHAR.org/<br /></code>'
			),
			array(
				'type' => 'checkbox',
				'name' => 'reduceload',
