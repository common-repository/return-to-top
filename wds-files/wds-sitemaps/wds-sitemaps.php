...
/**
 * CHAR DEV SEO pages optimization classes
 *
 * @package CHAR DEV SEO
 * @since 0.1
 */
...
//echo "<pre>" . var_export($sitemap_options,1)  . "</pre>";
    ...
    set_time_limit(120);
		...
		$output .= '<!-- ' . sprintf( __( 'XML Sitemap Generated by CHAR DEV SEO, containing %s' , 'wds'), count($stack) ) .' URLs -->'."\n";
...
class WDS_XML_News_Sitemap extends WDS_XML_Sitemap_Base {
	...
	function generate_sitemap( $sitemapurl, $sitemappath, $echo = false) {
		...
		$output .= '<!-- ' . __( 'XML NEWS Sitemap Generated by CHAR DEV SEO ' , 'wds') . ' -->'."\n";
